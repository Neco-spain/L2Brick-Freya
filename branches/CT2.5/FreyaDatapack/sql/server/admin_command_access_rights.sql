...
-- FENCE
('admin_fbuilder',1,'false'),
('admin_fence',1,'false'),
('admin_delallspawned',1,'false'),
('admin_dellastspawned',1,'false'),
...
-- MOVIE
('admin_addseq',1,'false'),
('admin_playseqq',1,'false'),
('admin_delsequence',1,'false'),
('admin_editsequence',1,'false'),
('admin_addsequence',1,'false'),
('admin_playsequence',1,'false'),
('admin_movie',1,'false'),
('admin_updatesequence',1,'false'),
('admin_brodcast',1,'false'),
('admin_playmovie',1,'false'),
('admin_brodmovie',1,'false'),
...
-- ADMIN TVT ROUND EVENT
('admin_tvtround_add',1,'false'),
('admin_tvtround_remove',1,'false'),
('admin_tvtround_advance',1,'false'),
...
-- Admin PA
('admin_premium_menu',1,'false'),
('admin_premium_add1',1,'false'),
('admin_premium_add2',1,'false'),
('admin_premium_add3',1,'false'),
...
-- CTF
('admin_ctf', 1, 'false'),
('admin_ctf_abort', 1, 'false'),
('admin_ctf_autoevent', 1, 'false'),
('admin_ctf_control', 1, 'false'),
('admin_ctf_desc', 1, 'false'),
('admin_ctf_dump', 1, 'false'),
('admin_ctf_edit', 1, 'false'),
('admin_ctf_eventtime', 1, 'false'),
('admin_ctf_finish', 1, 'false'),
('admin_ctf_flagholdtime', 1, 'false'),
('admin_ctf_join', 1, 'false'),
('admin_ctf_jointime', 1, 'false'),
('admin_ctf_join_loc', 1, 'false'),
('admin_ctf_load', 1, 'false'),
('admin_ctf_maxlvl', 1, 'false'),
('admin_ctf_maxplayers', 1, 'false'),
('admin_ctf_minlvl', 1, 'false'),
('admin_ctf_minplayers', 1, 'false'),
('admin_ctf_name', 1, 'false'),
('admin_ctf_npc', 1, 'false'),
('admin_ctf_npc_pos', 1, 'false'),
('admin_ctf_reward', 1, 'false'),
('admin_ctf_reward_amount', 1, 'false'),
('admin_ctf_save', 1, 'false'),
('admin_ctf_sit', 1, 'false'),
('admin_ctf_start', 1, 'false'),
('admin_ctf_team_add', 1, 'false'),
('admin_ctf_team_base_pos', 1, 'false'),
('admin_ctf_team_color', 1, 'false'),
('admin_ctf_team_flag', 1, 'false'),
('admin_ctf_team_pos', 1, 'false'),
('admin_ctf_team_remove', 1, 'false'),
('admin_ctf_teleport', 1, 'false'),
('admin_ctf_tele_flag', 1, 'false'),
('admin_ctf_tele_npc', 1, 'false'),
('admin_ctf_tele_team', 1, 'false'),
('admin_ctf_tele_team_base', 1, 'false');
