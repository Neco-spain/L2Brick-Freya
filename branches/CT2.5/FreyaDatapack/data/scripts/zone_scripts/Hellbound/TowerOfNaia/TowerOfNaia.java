...
package zone_scripts.Hellbound.TowerOfNaia;
...
import l2.brick.gameserver.util.MinionList;
...
public class TowerOfNaia extends Quest
{
  ...
  private class StopRoomTask implements Runnable
	...
	{
		new TowerOfNaia(-1, TowerOfNaia.class.getSimpleName(), "zone_scripts/Hellbound");
		if (Config.ENABLE_LOADING_INFO_FOR_SCRIPTS)
			_log.info("Loaded Hellbound: Tower of Naia");
	}
}
