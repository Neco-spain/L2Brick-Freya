...
import static l2.brick.gameserver.model.itemcontainer.PcInventory.MAX_ADENA;
...
import l2.brick.gameserver.model.actor.knownlist.NullKnownList;
import l2.brick.gameserver.model.quest.QuestState;
import l2.brick.gameserver.network.SystemMessageId;
import l2.brick.gameserver.network.serverpackets.DropItem;
import l2.brick.gameserver.network.serverpackets.GetItem;
import l2.brick.gameserver.network.serverpackets.InventoryUpdate;
import l2.brick.gameserver.network.serverpackets.SpawnItem;
...
import l2.brick.gameserver.templates.L2ItemType;
...
public final class L2ItemInstance extends L2Object
{
	...
	// Instance ID for Item.
	private String instanceNr = null;
	...
	/* (non-Javadoc)
	 * @see l2.brick.gameserver.model.L2Object#decayMe()
	 */
	@Override
	public void decayMe()
	{
	...
	{
		return instanceNr != null;
	}
	
	public boolean checkInstanceForItem(int charInstanceID)
	{
		final InstanceWorld world = InstanceManager.getInstance().getWorld(charInstanceID);
		if (world != null)			
			return instanceNr.contains(";" + world.templateId + ";");
