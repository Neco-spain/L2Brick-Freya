 ...
 */
package l2.brick.gameserver.model.olympiad;
...
import l2.brick.gameserver.model.zone.type.L2OlympiadStadiumZone;
...
public abstract class AbstractOlympiadGame
{
	...
	protected static SystemMessage checkDefaulted(L2PcInstance player)
	{
		...
		// safety precautions
		if (player.inObserverMode() || LMEvent.isPlayerParticipant(player.getObjectId()) || DM.isPlayerParticipant(player.getObjectId()) || TvTEvent.isPlayerParticipant(player.getObjectId()) || TvTRoundEvent.isPlayerParticipant(player.getObjectId()))
