...
import l2.brick.gameserver.ai.L2PlayerAI;
import l2.brick.gameserver.ai.L2SummonAI;
import l2.brick.gameserver.cache.HtmCache;
import l2.brick.gameserver.cache.WarehouseCacheManager;
import l2.brick.gameserver.communityboard.Forum;
import l2.brick.gameserver.communityboard.ForumsBBSManager;
import l2.brick.gameserver.communityboard.RegionBBSManager;
import l2.brick.gameserver.datatables.AIOItemTable;
import l2.brick.gameserver.datatables.AccessLevels;
import l2.brick.gameserver.datatables.AdminCommandAccessRights;
import l2.brick.gameserver.datatables.CharNameTable;
import l2.brick.gameserver.datatables.CharSummonTable;
...
import l2.brick.gameserver.datatables.FishTable;
import l2.brick.gameserver.datatables.HennaTable;
import l2.brick.gameserver.datatables.HeroSkillTable;
import l2.brick.gameserver.datatables.ItemTable;
import l2.brick.gameserver.datatables.NobleSkillTable;
...
import l2.brick.gameserver.instancemanager.AntiFeedManager;
...
import l2.brick.gameserver.instancemanager.DuelManager;
...
import l2.brick.gameserver.instancemanager.ItemsOnGroundManager;
import l2.brick.gameserver.instancemanager.LeaderboardArena;
import l2.brick.gameserver.instancemanager.LeaderboardTvT;
...
import l2.brick.gameserver.model.L2Macro;
import l2.brick.gameserver.model.L2ManufactureItem;
...
import l2.brick.gameserver.model.L2RecipeList;
import l2.brick.gameserver.model.L2Request;
...
import l2.brick.gameserver.model.L2UIKeysSettings;
...
import l2.brick.gameserver.model.MacroList;
import l2.brick.gameserver.model.PartyMatchRoom;
import l2.brick.gameserver.model.PartyMatchRoomList;
import l2.brick.gameserver.model.PartyMatchWaitingList;
import l2.brick.gameserver.model.ShortCuts;
import l2.brick.gameserver.model.TerritoryWard;
import l2.brick.gameserver.model.TradeList;
import l2.brick.gameserver.model.actor.L2Attackable;
import l2.brick.gameserver.model.actor.L2Character;
import l2.brick.gameserver.model.actor.L2Decoy;
...
import l2.brick.gameserver.model.actor.L2Vehicle;
import l2.brick.gameserver.model.actor.appearance.PcAppearance;
import l2.brick.gameserver.model.actor.knownlist.PcKnownList;
import l2.brick.gameserver.model.actor.position.PcPosition;
import l2.brick.gameserver.model.actor.stat.PcStat;
import l2.brick.gameserver.model.actor.status.PcStatus;
import l2.brick.gameserver.model.base.ClassId;
import l2.brick.gameserver.model.base.ClassLevel;
import l2.brick.gameserver.model.base.Experience;
import l2.brick.gameserver.model.base.PlayerClass;
import l2.brick.gameserver.model.base.Race;
import l2.brick.gameserver.model.base.SubClass;
...
import l2.brick.gameserver.model.entity.Duel;
import l2.brick.gameserver.model.entity.Fort;
import l2.brick.gameserver.model.entity.Hero;
...
import l2.brick.gameserver.model.itemcontainer.PcRefund;
import l2.brick.gameserver.model.itemcontainer.PcWarehouse;
import l2.brick.gameserver.model.itemcontainer.PetInventory;
import l2.brick.gameserver.model.multisell.PreparedListContainer;
...
import l2.brick.gameserver.model.zone.type.L2NoRestartZone;
...
import l2.brick.gameserver.network.serverpackets.ChangeWaitType;
...
import l2.brick.gameserver.network.serverpackets.ExDominionWarStart;
import l2.brick.gameserver.network.serverpackets.ExDuelUpdateUserInfo;
import l2.brick.gameserver.network.serverpackets.ExFishingEnd;
import l2.brick.gameserver.network.serverpackets.ExFishingStart;
import l2.brick.gameserver.network.serverpackets.ExGetBookMarkInfoPacket;
import l2.brick.gameserver.network.serverpackets.ExGetOnAirShip;
import l2.brick.gameserver.network.serverpackets.ExOlympiadMode;
import l2.brick.gameserver.network.serverpackets.ExPrivateStoreSetWholeMsg;
...
import l2.brick.gameserver.network.serverpackets.ExSpawnEmitter;
...
import l2.brick.gameserver.network.serverpackets.ExVitalityPointInfo;
import l2.brick.gameserver.network.serverpackets.ExVoteSystemInfo;
import l2.brick.gameserver.network.serverpackets.FriendStatusPacket;
import l2.brick.gameserver.network.serverpackets.GameGuardQuery;
import l2.brick.gameserver.network.serverpackets.GetOnVehicle;
...
import l2.brick.gameserver.network.serverpackets.LeaveWorld;
import l2.brick.gameserver.network.serverpackets.MagicSkillUse;
import l2.brick.gameserver.network.serverpackets.NicknameChanged;
import l2.brick.gameserver.network.serverpackets.NpcHtmlMessage;
import l2.brick.gameserver.network.serverpackets.ObservationMode;
import l2.brick.gameserver.network.serverpackets.ObservationReturn;
import l2.brick.gameserver.network.serverpackets.PartySmallWindowUpdate;
import l2.brick.gameserver.network.serverpackets.PetInventoryUpdate;
import l2.brick.gameserver.network.serverpackets.PlaySound;
import l2.brick.gameserver.network.serverpackets.PledgeShowMemberListDelete;
import l2.brick.gameserver.network.serverpackets.PledgeShowMemberListUpdate;
import l2.brick.gameserver.network.serverpackets.PrivateStoreListBuy;
import l2.brick.gameserver.network.serverpackets.PrivateStoreListSell;
import l2.brick.gameserver.network.serverpackets.PrivateStoreManageListBuy;
import l2.brick.gameserver.network.serverpackets.PrivateStoreManageListSell;
import l2.brick.gameserver.network.serverpackets.PrivateStoreMsgBuy;
import l2.brick.gameserver.network.serverpackets.PrivateStoreMsgSell;
import l2.brick.gameserver.network.serverpackets.RecipeShopMsg;
import l2.brick.gameserver.network.serverpackets.RecipeShopSellList;
import l2.brick.gameserver.network.serverpackets.RelationChanged;
import l2.brick.gameserver.network.serverpackets.Ride;
import l2.brick.gameserver.network.serverpackets.ServerClose;
import l2.brick.gameserver.network.serverpackets.SetupGauge;
import l2.brick.gameserver.network.serverpackets.ShortBuffStatusUpdate;
...
import l2.brick.gameserver.network.serverpackets.SkillList;
import l2.brick.gameserver.network.serverpackets.Snoop;
...
import l2.brick.gameserver.network.serverpackets.StopMove;
import l2.brick.gameserver.network.serverpackets.SystemMessage;
import l2.brick.gameserver.network.serverpackets.TargetSelected;
import l2.brick.gameserver.network.serverpackets.TargetUnselected;
import l2.brick.gameserver.network.serverpackets.TradeDone;
import l2.brick.gameserver.network.serverpackets.TradeOtherDone;
import l2.brick.gameserver.network.serverpackets.TradeStart;
...
import l2.brick.gameserver.skills.l2skills.L2SkillSiegeFlag;
import l2.brick.gameserver.skills.l2skills.L2SkillSummon;
import l2.brick.gameserver.skills.l2skills.L2SkillTrap;
import l2.brick.gameserver.taskmanager.AttackStanceTaskManager;
import l2.brick.gameserver.templates.EffectTemplate;
import l2.brick.gameserver.templates.L2Armor;
import l2.brick.gameserver.templates.L2ArmorType;
...
import l2.brick.gameserver.templates.L2PcTemplate;
...
import l2.brick.gameserver.util.FloodProtectors;
...
{
	public boolean _useAutoLoot = Config.AUTO_LOOT, _useAutoLootHerbs = Config.AUTO_LOOT_HERBS;
	...
	private int _crystalCavernsZoneDoor = 0;
	private int _crystalCavernsDoor = 0;
	...
	private FastMap<String, FastList<L2Skill>> _schemeSets = new FastMap<String, FastList<L2Skill>>();
	...
	/**
	 * 
	 * @see l2.brick.gameserver.model.actor.L2Character#enableSkill(l2.brick.gameserver.model.L2Skill)
	 */
	@Override
	...
	/**
	 * 
	 * @see l2.brick.gameserver.model.actor.L2Character#checkDoCastConditions(l2.brick.gameserver.model.L2Skill)
	 */
	@Override
	 ...
	 *
	 *
	 * @see l2.brick.gameserver.model.actor.L2Playable#doDie(l2.brick.gameserver.model.actor.L2Character)
	 */
	@Override
	public boolean doDie(L2Character killer)
	{
		...
		if (killer != null)
		{
			...
			if (Config.DM_EVENT_ENABLED && DM.isStarted())
			DM.onKill(killer, this);
			...
			// Rank Arena
			if (Config.RANK_ARENA_ENABLED && killer instanceof L2PcInstance && isInsideZone(L2Character.ZONE_PVP) && !isInSiege() && !TvTEvent.isPlayerParticipant(getObjectId()))
			{
				if(!killer.isGM() && !isGM()){
					LeaderboardArena.getInstance().onKill(killer.getObjectId(), killer.getName());
					LeaderboardArena.getInstance().onDeath(getObjectId(), getName());
				}
			}
			...
			{
				if(!killer.isGM() && !isGM()){
					LeaderboardTvT.getInstance().onKill(killer.getObjectId(), killer.getName());
					LeaderboardTvT.getInstance().onDeath(getObjectId(), getName());
				}
			}
	...
	{
		if (atEvent || (CTF._started && _inEventCTF) || (DM.isStarted() && isInEventDM()) || killer == null)
			return;
	...
	{
		if (DM.isStarted() && isInEventDM()) return;
				...
				&& AntiFeedManager.getInstance().check(this, target))
		{
			...
			final int newPvps = getPvpKills() + 1;
			setPvpKills(newPvps);
			AIOItemTable.getInstance().onPvpIncrease(this);
	...
	public void increasePkKillsAndKarma(L2Character target)
	{
		...
		if (target instanceof L2PcInstance
				&& AntiFeedManager.getInstance().check(this, target))
		{
			final int newPks = getPkKills() + 1;
			setPkKills(newPks);
			AIOItemTable.getInstance().onPkIncrease(this);
		}
	...
	public void updatePvPStatus(L2Character target)
	{
		...
		if (DM.isStarted() && isInEventDM() && player_target.isInEventDM())
			return;
	...
	public void deathPenalty(boolean atwar, boolean killed_by_pc, boolean killed_by_siege_npc)
	{
		...
		long lostExp = 0;
		if (!atEvent && !isInEventDM() || !_inEventCTF)
	...
	public boolean mountPlayer(L2Summon pet)
	{
		if (pet != null && pet.isMountable() && !isMounted() && !isBetrayed())
		{
			...
			else if (_haveFlagCTF)
			{
				...
				sendPacket(ActionFailed.STATIC_PACKET);
				sendPacket(SystemMessage.getSystemMessage(SystemMessageId.YOU_CANNOT_MOUNT_A_STEED_WHILE_HOLDING_A_FLAG));
				return false;
			}
			else if (pet.isDead())
			{
	...
	public boolean isAutoAttackable(L2Character attacker)
	{
		...
		if (CTF._started && ((L2PcInstance) attacker)._inEventCTF)
			return true;
		...
		if (DM.isStarted()&& isInEventDM() && ((L2PcInstance)attacker).isInEventDM())
			return true;
		...
		if (DM.isStarted() && DM.isPlayerParticipant(getObjectId()))
			return true;
	...
	private boolean checkUseMagicConditions(L2Skill skill, boolean forceUse, boolean dontMove)
	{
		...
		if (skill.isOffensive())
		{
			if ((isInsidePeaceZone(this, target)) && !getAccessLevel().allowPeaceAttack())
			{
				...
				if(!this.isInEventDM() || !((L2PcInstance)target).isInEventDM())
				{
					// If L2Character or target is in a peace zone, send a system message TARGET_IN_PEACEZONE a Server->Client packet ActionFailed
	...
	{
		if (isInEventDM() && DM.isStarted()) return true;
	...
	private synchronized void cleanup()
	{
		...
		if (Config.ALLOW_MAX_PLAYERS_FROM_ONE_PC) 
		{
			try 
			{
				if (Config.MAX_PLAYERS_FROM_ONE_PC > 0 && getClient() != null&& getClient().getAdress() != null&& getClient().getTrace() != null) 
					  {
	...
	public void setPunishLevel(PunishLevel state, int delayInMinutes)
	{
		...
		switch (state)
		{
			...
			case JAIL: // Jail Player
			{
				...
				if (!DM.isInactive() && DM.isPlayerParticipant(getObjectId()))
					DM.removeParticipant(this);
	...
	public void calculateDeathPenaltyBuffLevel(L2Character killer)
	{
		if((getKarma() > 0 || Rnd.get(1,100) <= Config.DEATH_PENALTY_CHANCE)
				...
				&& !(DM.isStarted() && DM.isPlayerParticipant(getObjectId())) 
				&& !(TvTRoundEvent.isStarted() && TvTRoundEvent.isPlayerParticipant(getObjectId()))
	...
	public static boolean checkSummonerStatus(L2PcInstance summonerChar)
	{
		...
		if (!TvTEvent.onEscapeUse(summonerChar.getObjectId()) || !LMEvent.onEscapeUse(summonerChar.getObjectId()) || !DM.onEscapeUse(summonerChar.getObjectId()))
		{
	...
	public static boolean checkSummonTargetStatus(L2Object target, L2PcInstance summonerChar)
	{
		...
		if (!TvTEvent.onEscapeUse(targetChar.getObjectId()) || !LMEvent.onEscapeUse(targetChar.getObjectId()) || !DM.onEscapeUse(summonerChar.getObjectId()))
		{
			summonerChar.sendPacket(SystemMessage.getSystemMessage(SystemMessageId.YOUR_TARGET_IS_IN_AN_AREA_WHICH_BLOCKS_SUMMONING));
			return false;
		}
	...
	/* (non-Javadoc)
	 * @see l2.brick.gameserver.model.actor.L2Character#isMovementDisabled()
	 */
	@Override
    ...
    public void giveItems(int itemId, long count, int enchantlevel)
	{
        ...
        {
		    item = getInventory().addItem("Other", itemId, count, this, getTarget());
        ...
        else
        {
            ...
            {
                item = getInventory().addItem("Other", itemId, 1, this, getTarget());
                iu.addModifiedItem(item);
            }
        }
		...
		if (item == null)
			return;
		if (enchantlevel > 0 && (item.getWeaponItem() != null || item.getArmorItem() != null))
			item.setEnchantLevel(enchantlevel);
		if (itemId == 57)
			sendPacket(SystemMessage.getSystemMessage(SystemMessageId.EARNED_S2_S1_S).addItemNumber(count));
		else
		{
			if (count > 1)
				sendPacket(SystemMessage.getSystemMessage(SystemMessageId.EARNED_S2_S1_S).addItemName(item).addItemNumber(count));
			else
				sendPacket(SystemMessage.getSystemMessage(SystemMessageId.EARNED_ITEM_S1).addItemName(item));
		}
		sendPacket(iu);
	}
	/**
	 * Returns if the current warehouse being used
	 * by this L2PcInstance is an AIOItem wh
	 * @return _isAioWh
	 */
	...
	/**
	 * Changes the _isAioWh field value to the given
	 * one
	 * @param b [boolean]
	 */
	...
	/**
	 * Returns if the current Multisell being used
	 * by this L2PcInstance is an AIOItem multisell
	...
	/**
	 * Changes the _isAioMultisell field value to the given
	 * one
	 * @param b [boolean]
	 */
	...
	/**
	 * Will return a Set of Strings containing all
	 * profiles names
	 * @return Set<String>
	 */
	...
	/**
	 * Will return an ArrayList with all set's buff
	 * @param set
	 * @return ArrayList<L2Skill>
	 */
	...
	/**
	 * Sets the variable to make the save at char
	 * log out
	 */
	...
	/**
	 * Will add a new profile in the player map
	 * @param profile
	 */
	public void addNewProfile(String profile)
	{
		FastList<L2Skill> temp = new FastList<L2Skill>(Config.AIOITEM_SCHEME_MAX_PROFILES);
		_schemeSets.put(profile, temp);
	}
	
	/**
	 * Will add a new buff in the given profile
	 * @param profile
	 * @param buff [L2Skill]
	 */
	...
	/**
	 * Will remove the given profile from the player's
	 * scheme list
	 * @param profile
	 */
	...
	/**
	 * Will remove the given buff from the given profile
	 * @param profile
	 * @param buff
	 */
	...
	/**
	 * Will load all buffs for the player's scheme profiles
	 */
	public void loadSchemesFromDatabase()
	{
		if(!Config.AIOITEM_ENABLEME || !Config.AIOITEM_ENABLESCHEMEBUFF)
			return;
		...
		try
		{
			...
			FastList<String> tempProfiles = new FastList<String>(Config.AIOITEM_SCHEME_MAX_PROFILES);
			...
			{
				FastList<L2Skill> tempSkill = new FastList<L2Skill>(Config.AIOITEM_SCHEME_MAX_PROFILE_BUFFS);
	...
	/**
	 * Will set the last category the player navigate
	 * througt to send him back a window with those category
	 * buffs
	 * @param cat [String]
	 */
	...
	/**
	 * Return the last category used in the AIOItem buffer/scheme
	 * @return String
	 */
   ...
   private boolean _OfflineSuperMode = false;
   
   public void setOfflineSuperMode(boolean osupermode)
   {
       _OfflineSuperMode = osupermode;
   }
   /**
    * Return if Player is in Offline Mode, but online with other player
    * @return  boolean
    */
   public boolean getOfflineSuperMode()
   {
       return _OfflineSuperMode;
   }
	...
	{
	if ((Config.ENABLE_BLOCK_EXP && _addXpSp) || (!Config.ENABLE_BLOCK_EXP))
    ...
    public void setCrystalCavernsZoneDoor(int zoneDoor)
    {
        if(zoneDoor == 0)
            setCrystalCavernsDoor(0);
        _crystalCavernsZoneDoor = zoneDoor;
    }

    public int getCrystalCavernsZoneDoor()
    {
        return _crystalCavernsZoneDoor;
    }

    public void setCrystalCavernsDoor(int door)
    {
        _crystalCavernsDoor = door;
    }

    public int getCrystalCavernsDoor()
    {
        return _crystalCavernsDoor;
    }
