...
import static l2.brick.gameserver.ai.CtrlIntention.AI_INTENTION_ACTIVE;
import static l2.brick.gameserver.ai.CtrlIntention.AI_INTENTION_FOLLOW;
...
import l2.brick.gameserver.instancemanager.MapRegionManager.TeleportWhereType;
import l2.brick.gameserver.instancemanager.TerritoryWarManager;
import l2.brick.gameserver.instancemanager.TownManager;
import l2.brick.gameserver.model.ChanceSkillList;
import l2.brick.gameserver.model.CharEffectList;
import l2.brick.gameserver.model.FusionSkill;
import l2.brick.gameserver.model.IChanceSkillTrigger;
...
import l2.brick.gameserver.model.actor.instance.L2NpcWalkerInstance;
import l2.brick.gameserver.model.actor.instance.L2PcInstance;
import l2.brick.gameserver.model.actor.instance.L2PcInstance.SkillDat;
...
import l2.brick.gameserver.model.actor.knownlist.CharKnownList;
import l2.brick.gameserver.model.actor.position.CharPosition;
import l2.brick.gameserver.model.actor.stat.CharStat;
import l2.brick.gameserver.model.actor.status.CharStatus;
...
import l2.brick.gameserver.network.serverpackets.AbstractNpcInfo;
import l2.brick.gameserver.network.serverpackets.ActionFailed;
import l2.brick.gameserver.network.serverpackets.Attack;
import l2.brick.gameserver.network.serverpackets.ChangeMoveType;
import l2.brick.gameserver.network.serverpackets.ChangeWaitType;
import l2.brick.gameserver.network.serverpackets.FlyToLocation;
import l2.brick.gameserver.network.serverpackets.FlyToLocation.FlyType;
import l2.brick.gameserver.network.serverpackets.L2GameServerPacket;
import l2.brick.gameserver.network.serverpackets.MagicSkillCanceld;
...
import l2.brick.gameserver.network.serverpackets.Revive;
import l2.brick.gameserver.network.serverpackets.ServerObjectInfo;
...
import l2.brick.gameserver.network.serverpackets.TeleportToLocation;
import l2.brick.gameserver.pathfinding.AbstractNodeLoc;
import l2.brick.gameserver.pathfinding.PathFinding;
import l2.brick.gameserver.skills.AbnormalEffect;
import l2.brick.gameserver.skills.Calculator;
import l2.brick.gameserver.skills.Formulas;
import l2.brick.gameserver.skills.Stats;
import l2.brick.gameserver.skills.effects.EffectChanceSkillTrigger;
import l2.brick.gameserver.skills.funcs.Func;
import l2.brick.gameserver.skills.l2skills.L2SkillAgathion;
import l2.brick.gameserver.skills.l2skills.L2SkillMount;
import l2.brick.gameserver.skills.l2skills.L2SkillSummon;
import l2.brick.gameserver.taskmanager.AttackStanceTaskManager;
import l2.brick.gameserver.templates.L2CharTemplate;
...
public abstract class L2Character extends L2Object
{
	...
	public boolean doDie(L2Character killer)
	{
		...
		else if (this instanceof L2Playable && Config.ALT_KEEP_BUFF_AFTER_DEATH)
		{
			if (((L2Playable)this).isNoblesseBlessed())
			{
				((L2Playable)this).stopNoblesseBlessing(null);
	 ...
	 *
	 * @see l2.brick.gameserver.model.L2Character.isInsideRadius(int x, int y, int z, int radius, boolean checkZ, boolean strictCheck)
	 */
