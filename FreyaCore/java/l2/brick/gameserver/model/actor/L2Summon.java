...
import l2.brick.gameserver.model.actor.L2Attackable.AggroInfo;
...
import l2.brick.gameserver.model.actor.knownlist.SummonKnownList;
import l2.brick.gameserver.model.actor.stat.SummonStat;
import l2.brick.gameserver.model.actor.status.SummonStatus;
...
import l2.brick.gameserver.network.serverpackets.ExPartyPetWindowUpdate;
import l2.brick.gameserver.network.serverpackets.L2GameServerPacket;
import l2.brick.gameserver.network.serverpackets.PetDelete;
import l2.brick.gameserver.network.serverpackets.PetInfo;
import l2.brick.gameserver.network.serverpackets.PetItemList;
import l2.brick.gameserver.network.serverpackets.PetStatusUpdate;
...
import l2.brick.gameserver.templates.L2EtcItem;
...
public abstract class L2Summon extends L2Playable
{
	...
	public boolean useMagic(L2Skill skill, boolean forceUse, boolean dontMove)
	{
		...
		if (skill.isOffensive())
		{
			if (isInsidePeaceZone(this, target)
					...
					&& (!this.isInFunEvent() || !target.isInFunEvent()))
			{
	...
	/* (non-Javadoc)
	 * @see l2.brick.gameserver.model.actor.L2Character#onTeleported()
	 */
	@Override
