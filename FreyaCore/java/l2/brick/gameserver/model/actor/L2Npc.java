...
import l2.brick.gameserver.model.L2NpcAIData;
...
import l2.brick.gameserver.model.actor.instance.L2ClanHallManagerInstance;
import l2.brick.gameserver.model.actor.instance.L2DoormenInstance;
import l2.brick.gameserver.model.actor.instance.L2FestivalGuideInstance;
import l2.brick.gameserver.model.actor.instance.L2FishermanInstance;
...
import l2.brick.gameserver.model.actor.instance.L2TeleporterInstance;
import l2.brick.gameserver.model.actor.instance.L2TrainerInstance;
import l2.brick.gameserver.model.actor.instance.L2WarehouseInstance;
import l2.brick.gameserver.model.actor.knownlist.NpcKnownList;
import l2.brick.gameserver.model.actor.stat.NpcStat;
import l2.brick.gameserver.model.actor.status.NpcStatus;
...
import l2.brick.gameserver.model.zone.type.L2TownZone;
...
import l2.brick.gameserver.network.serverpackets.ExChangeNpcState;
...
import l2.brick.gameserver.templates.L2NpcTemplate.AIType;
...
public class L2Npc extends L2Character
{
	...
	/** Add by DM Event **/
	private boolean _isEventMobDM = false;
	...
	public boolean useSoulShot()
	{
		...
		else if (_soulshotamount>0)
		{
			if (Rnd.get(100) <= getSoulShotChance())
			{
				...
				Scenkos.toSelfAndKnownPlayersInRadius(this, new MagicSkillUse(this, this, 2154, 1, 0, 0), 360000);
		...
		else
		{
			...
			else if (_spiritshotamount>0)
			{
				if (Rnd.get(100) <= getSpiritShotChance())
				{
					...
					Scenkos.toSelfAndKnownPlayersInRadius(this, new MagicSkillUse(this, this, 2061, 1, 0, 0), 360000);
	...
	*/
    ...
    public void setAdditionalData(Object val)
    {
        additionalData = val;
    }
	...
	public boolean isEventMobDM()
	{
		return _isEventMobDM;
	}
	
	public void setIsEventMobDM(boolean val)
	{
		_isEventMobDM = val;
	}
}
