...
import l2.brick.gameserver.model.L2SiegeClan;
...
import l2.brick.gameserver.model.actor.instance.L2BabyPetInstance;
import l2.brick.gameserver.model.actor.instance.L2CubicInstance;
...
import l2.brick.gameserver.model.base.PlayerState;
...
import l2.brick.gameserver.model.zone.type.L2CastleZone;
import l2.brick.gameserver.model.zone.type.L2ClanHallZone;
import l2.brick.gameserver.model.zone.type.L2FortZone;
import l2.brick.gameserver.model.zone.type.L2MotherTreeZone;
import l2.brick.gameserver.network.SystemMessageId;
import l2.brick.gameserver.network.serverpackets.ExShowScreenMessage;
import l2.brick.gameserver.network.serverpackets.SystemMessage;
import l2.brick.gameserver.skills.conditions.ConditionPlayerState;
import l2.brick.gameserver.skills.conditions.ConditionUsingItemType;
			...
			if (attacker instanceof L2PcInstance)
			{
				...
				else
				{
					...
					if (Config.SHOW_DAMAGE_MESSAGE_ON_CENTER_TOP_SCREEN)
						attacker.sendPacket(new ExShowScreenMessage(1,0,Config.SCREEN_POSITION,0,0,0,0,false,3000,1,"Your skill " + skill.getName() + " attack is not successful !"));
	...
	public static final double calcMagicDam(L2CubicInstance attacker, L2Character target, L2Skill skill, boolean mcrit, byte shld)
	{
		...
		if (Config.ALT_GAME_MAGICFAILURES && !calcMagicSuccess(owner, target, skill))
		{
			...
			else
			{
				SystemMessage sm = SystemMessage.getSystemMessage(SystemMessageId.C1_RESISTED_YOUR_S2);
				if (Config.SHOW_DAMAGE_MESSAGE_ON_CENTER_TOP_SCREEN)
					owner.sendPacket(new ExShowScreenMessage(1,0,Config.SCREEN_POSITION,0,0,0,0,false,3000,1,"Your skill attack is not successful !"));
				sm.addCharName(target);
				sm.addSkillName(skill);
				owner.sendPacket(sm);
