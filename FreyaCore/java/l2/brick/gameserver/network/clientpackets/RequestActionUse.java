...
import l2.brick.gameserver.datatables.SummonSkillsTable;
...
import l2.brick.gameserver.model.actor.instance.L2StaticObjectInstance;
...
import l2.brick.gameserver.network.serverpackets.ChairSit;
import l2.brick.gameserver.network.serverpackets.ExAskCoupleAction;
import l2.brick.gameserver.network.serverpackets.ExBasicActionList;
import l2.brick.gameserver.network.serverpackets.RecipeShopManageList;
			...
			case 22: // Attack (pet attack)
				if (target != null && pet != null && pet != target && activeChar != target && !pet.isBetrayed())
				{
					...
					if (!activeChar.getAccessLevel().allowPeaceAttack() && activeChar.isInsidePeaceZone(pet, target) 
							&& (!activeChar.isInFunEvent() || !target.isInFunEvent()))
					{
