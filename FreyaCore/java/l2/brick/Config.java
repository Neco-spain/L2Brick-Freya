...
public final class Config
{
	...
	public static final String SERVER_VERSION_FILE = "./config/ServerSettings/l2brick-version.properties";
	public static final String DATAPACK_VERSION_FILE = "./config/ServerSettings/l2brickdp-version.properties";
		...
		if(Server.serverMode == Server.MODE_GAMESERVER)
		{
			...
			try
			{
				...
				try
				{
					...
					VOTE_REWARD1_COUNT = Integer.parseInt(votereward.getProperty("VoteReward1Count", "1000"));
					VOTE_REWARD2_COUNT = Integer.parseInt(votereward.getProperty("VoteReward2Count", "1000"));
					VOTE_REWARD1_ID = Integer.parseInt(votereward.getProperty("VoteReward1Id", "57"));
					VOTE_REWARD2_ID = Integer.parseInt(votereward.getProperty("VoteReward2Id", "57"));
					VOTES_FOR_REWARD = Integer.parseInt(votereward.getProperty("VotesForReward", "5"));
					VOTE_REWARD_ENABLE = Boolean.parseBoolean(votereward.getProperty("EnableVoteReward", "False"));
					SERVER_NAME_FOR_VOTES = votereward.getProperty("ServerNameForVotes", "L2ServerName");
